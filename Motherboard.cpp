...
Motherboard::Motherboard(const std::string &name, const std::string &socketType, int numberOfRamSlots, int numberOfGraphicsCardSlots)
    ...
    , m_numberOfRamSlots(numberOfRamSlots), m_numberOfGraphicsCardSlots(numberOfGraphicsCardSlots) {}
...
std::string Motherboard::getPartInformation() const
{
    ...
    partInformation += "No. of Ram Slots: " + std::string(numberOfRamSlots) + ", No. of Graphics Cards Permitted: " + std::string(numberOfGraphicsCardSlots);
