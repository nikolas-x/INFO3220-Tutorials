...
int main()
{
    ...
    if (!computerCaseTest())
    {
        std::cout << "Computer case test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerPowerSupplyTest())
    {
        std::cout << "Computer power supply test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerMotherboardTest())
    {
        std::cout << "Computer motherboard test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerCPUTest())
    {
        std::cout << "Computer cpu test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerRamTest())
    {
        std::cout << "Computer ram test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerRamDeepCopyTest())
    {
        std::cout << "Computer ram deep copy test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerHardDrivesTest())
    {
        std::cout << "Computer hard drives test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerHardDrivesDeepCopyTest())
    {
        std::cout << "Computer hard drives deep copy test failed" << std::endl;
        numberOfTestsFailed++;
    }
    ...
    {
        std::cout << "Computer graphics card deep copy test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerWaterCoolingTest())
    {
        std::cout << "Computer water cooling test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerFanTest())
    {
        std::cout << "Computer fan test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerDVDDriveTest())
    {
        std::cout << "Computer dvd drive test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!computerBluRayTest())
    {
        std::cout << "Computer bluray test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildFullComputerTest())
    {
        std::cout << "Computer full build test failed" << std::endl;
        numberOfTestsFailed++;
    }
    ...
    {
        std::cout << "Builder creation test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildOfficeComputerTest1())
    {
        std::cout << "Builder office 1 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildOfficeComputerTest2())
    {
        std::cout << "Builder office 2 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildOfficeComputerTest3())
    {
        std::cout << "Builder office 3 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildServerTest1())
    {
        std::cout << "Builder server 1 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildServerTest2())
    {
        std::cout << "Builder server 2 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildServerTest3())
    {
        std::cout << "Builder server 3 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildGamingComputerTest1())
    {
        std::cout << "Builder gamimg 1 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildGamingComputerTest2())
    {
        std::cout << "Builder gaming 2 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!buildGamingComputerTest3())
    {
        std::cout << "Builder gaming 3 test failed" << std::endl;
        numberOfTestsFailed++;
    }
    ...
    {
        std::cout << "Visitor blu ray counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitCaseUsingCountingVisitorTest())
    {
        std::cout << "Visitor case counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitCoolingFanUsingCountingVisitorTest())
    {
        std::cout << "Visitor cooling fan counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitCPUUsingCountingVisitorTest())
    {
        std::cout << "Visitor cpu counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitDVDDriveUsingCountingVisitorTest())
    {
        std::cout << "Visitor dvd drive counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitGraphicsCardUsingCountingVisitorTest())
    {
        std::cout << "Visitor graphics card counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitHardDriveUsingCountingVisitorTest())
    {
        std::cout << "Visitor hard drive counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitMotherboardUsingCountingVisitorTest())
    {
        std::cout << "Visitor motherboard counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitPowerSupplyUsingCountingVisitorTest())
    {
        std::cout << "Visitor power supply counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitRamUsingCountingVisitorTest())
    {
        std::cout << "Visitor ram counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitWaterCoolingUsingCountingVisitorTest())
    {
        std::cout << "Visitor water cooling counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitOptionalPartsUsingCountingVisitorTest())
    {
        std::cout << "Visitor optional parts counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitRequiredPartsUsingCountingVisitorTest())
    {
        std::cout << "Visitor required parts counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
    if (!visitAllPartsUsingCountingVisitorTest())
    {
        std::cout << "Visitor all parts counting test failed" << std::endl;
        numberOfTestsFailed++;
    }
